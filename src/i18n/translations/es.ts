...
export const es: TranslationSchema = {
  ...
  footer: {
    ...
    appleAffiliation: 'Read Later es una aplicación independiente, no afiliada a Apple Inc.',
  ...
  showcaseQuickSave: {
    ...
    imageAlt: 'La app Read Later en un iPhone mostrando la biblioteca en modo oscuro con fotos, títulos y etiquetas de los elementos guardados.'
  },
  showcaseLibrary: {
    ...
    imageAlt: 'La app Read Later en un iPhone mostrando fichas detalladas de elementos guardados que incluyen recetas, planes de viaje, diseño y restaurantes.'
  },
  showcaseIpad: {
    eyebrow: 'iPad',
    ...
    imageAltDark: 'La app Read Later en un iPad en modo oscuro, mostrando la pantalla de inicio de Colecciones con atajos de búsqueda rápida y favoritos.',
    imageAltLight: 'La app Read Later en un iPad en modo claro, mostrando la pantalla de inicio de Colecciones con atajos de búsqueda rápida y favoritos.'
  },
  showcaseCollections: {
    eyebrow: 'Colecciones',
    headline: 'Comparte',
  ...
  splitHeadlinePrivacy: {
    ...
    first: 'Privado,',
    second: 'por defecto.',
    body: 'Sin cuentas. Sin rastreo. Sin SDK de terceros. Todo lo que haces en Read Later se queda en tu iPhone, tu iPad y tu propia cuenta de iCloud.'
  },
  bento: {
    eyebrow: 'Funciones',
    headline: 'Sencillo,',
    ...
    shareExtension: {
      ...
      alt: 'Menú de compartir de iOS con contactos de AirDrop y la acción de guardar de Read Later'
    },
    collections: {
      eyebrow: 'Colecciones',
  ...
  integration: {
    ...
    siri: {
      eyebrow: 'Siri',
      title: 'Solo pídelo',
      body: 'Pídele a Siri que guarde un enlace en Read Later, que busque en la app o que te diga qué has guardado.'
    },
    shortcuts: {
      eyebrow: 'Atajos',
  ...
  privacyPage: {
    metaTitle: 'Política de Privacidad - Read Later',
    metaDescription: 'Cómo trata Read Later tus datos. Sin cuenta. Sin rastreo. Tus datos viven en tu dispositivo y se sincronizan a través de tu propia cuenta de iCloud.',
    eyebrow: 'Aviso legal',
    headline: 'Privacidad.',
    headlineDim: 'Por defecto.',
    lastUpdated: '10 de junio de 2026',
    intro: 'Esta política explica en un lenguaje sencillo qué hace Read Later con tu información. El resumen es rápido: no hace casi nada, a propósito.',
    ...
    sections: [
      {
        title: 'Quiénes somos',
        body: 'Read Later (la "App") es publicada por un desarrollador independiente con sede en el Reino Unido ("nosotros", "nuestro"). Somos los responsables del tratamiento de la información personal que decidas enviarnos, como un correo de soporte. Para dudas sobre privacidad, escribe a support@getreadlater.com.'
      },
      {
        title: 'La versión corta',
        body: 'La App no requiere crear ninguna cuenta de Read Later ni utiliza servidores de contenido propios. No recibimos tus enlaces guardados, notas, etiquetas ni Colecciones. Esa biblioteca se guarda en tu dispositivo y, si lo activas, en tu iCloud de Apple. La App no contiene publicidad, rastreo entre aplicaciones ni SDK de analíticas de terceros. A continuación detallamos los datos de soporte, registros de la web y la información que Apple proporciona a los desarrolladores.'
      },
      {
        title: 'Qué datos procesa la app y dónde viven',
        body: 'En tu dispositivo, las URL, títulos, portadas, notas, etiquetas y el estado de lectura se guardan usando las herramientas estándar de Apple. Si iCloud está activo, Apple CloudKit almacena y sincroniza ese contenido bajo tu Apple ID. Read Later no gestiona una base de datos externa ni nos permite leer tu biblioteca. Si compartes una Colección, Apple procesa una copia para que el destinatario la añada de forma independiente. Las copias no son colaborativas.'
      },
      {
      ...
      {
        title: 'Contacto',
        body: 'Si tienes dudas o solicitudes sobre privacidad, puedes escribir a support@getreadlater.com. Disponemos de una dirección postal formal bajo petición.'
      }
    ]
  },
  supportPage: {
    metaTitle: 'Soporte - Read Later',
    metaDescription: 'Ayuda y respuestas para Read Later. Guarda lo que quieras. Encuéntralo todo.',
    eyebrow: 'Soporte',
    ...
    faqs: [
      {
        ...
        a: 'Abre el enlace en Safari o en cualquier otra app, toca el botón Compartir de iOS y elige Read Later. Si quieres, añade etiquetas, notas o asígnalo a una colección, y toca Guardar. Se añadirá a tu biblioteca al instante.'
      },
      {
      ...
      },
      {
        ...
        a: 'Abre una colección, toca el menú y selecciona Compartir colección. Esto envía una copia para que la otra persona la añada a su propia biblioteca de Read Later. Su copia será independiente: los cambios o elementos añadidos después por cualquiera de los dos no se actualizarán en el otro dispositivo.'
      },
      {
        q: '¿Se sincroniza Read Later entre mi iPhone y mi iPad?',
        a: 'Sí. Si has iniciado sesión en iCloud, Read Later sincroniza automáticamente tu biblioteca entre todos tus dispositivos mediante CloudKit. No hay que activar ningún ajuste: simplemente funciona.'
      },
      {
        q: 'He alcanzado el límite de 100 guardados. ¿Qué hago?',
        a: 'La versión gratuita permite guardar hasta 100 elementos. Para eliminar este límite, suscríbete a Read Later Plus desde los Ajustes de la app, bien por 12,99 € al año o mediante un pago único de 34,99 € de por vida. Plus también activa las colecciones ilimitadas.'
      },
      {
        q: '¿Cómo cancelo la suscripción a Plus?',
        a: 'Las suscripciones las gestiona Apple. Abre los Ajustes de iOS, toca tu nombre, ve a Suscripciones, busca Read Later y toca Cancelar. Seguirás teniendo acceso a Plus hasta el final del periodo de facturación actual.'
      },
      {
        q: '¿Puedo solicitar un reembolso?',
        a: 'Los reembolsos de compras en el App Store los procesa directamente Apple. Entra en reportaproblem.apple.com, inicia sesión, busca tu compra de Read Later y solicita el reembolso.'
      },
      {
        q: 'He encontrado un fallo. ¿Qué hago?',
        a: 'Escribe a support@getreadlater.com detallando brevemente qué estabas haciendo, qué esperabas que pasara y qué ha ocurrido en realidad. Si adjuntas una captura de pantalla, nos ayuda muchísimo.'
      }
    ]
  },
  termsPage: {
    metaTitle: 'Condiciones de Uso - Read Later',
    metaDescription: 'Las condiciones explicadas de manera sencilla que se aplican al descargar o usar la aplicación Read Later.',
    eyebrow: 'Aviso legal',
    headline: 'Condiciones',
    headlineDim: 'de Uso.',
    lastUpdated: '10 de junio de 2026',
    intro: 'Estas condiciones se aplican al descargar o utilizar la aplicación de iOS Read Later (“Read Later”, “nosotros”, “nuestro”). Al usar Read Later, aceptas estas condiciones junto con el contrato de licencia estándar (EULA) de Apple. Las hemos redactado en un lenguaje claro y accesible.',
    tldrTitle: 'En resumen',
    tldr: [
      'Read Later se te concede bajo licencia para uso personal en tus dispositivos Apple.',
    ...
    sections: [
      {
        ...
        body: 'Estas condiciones regulan el uso de la aplicación de iOS Read Later ("Read Later", la "App"). La App la publica un desarrollador independiente con sede en el Reino Unido. Al utilizar Read Later, aceptas estas condiciones junto con la Licencia de Usuario Final estándar de Apple (el "EULA de Apple").'
      },
      {
        title: '2. La licencia',
      ...
      {
        title: '5. Reembolsos',
        body: 'Todas las compras en Read Later las procesa Apple bajo las Condiciones de los Servicios Multimedia de Apple. Apple, y no nosotros, gestiona los reembolsos. Puedes solicitar un reembolso en reportaproblem.apple.com o a través del historial de compras de tu Apple ID. Nosotros no podemos emitir reembolsos directos ni guardamos tus datos de pago.',
        link: {
      ...
      },
      {
        ...
        body: 'Todo lo que guardes en Read Later (enlaces, etiquetas, notas, la estructura de tus Colecciones) te pertenece. No reclamamos ninguna licencia sobre tus contenidos ni accedemos a ellos. Eres responsable de lo que guardas: por favor, no utilices Read Later para almacenar o compartir material ilegal, que infrinja derechos de terceros o que constituya acoso. Respeta las condiciones de las webs que guardas.'
      },
      {
      ...
      },
      {
        ...
        body: 'Queda prohibido: (a) realizar ingeniería inversa, descompilar o modificar Read Later salvo que lo permita expresamente la ley o el EULA de Apple; (b) eludir las comprobaciones de licencia o compras; (c) usar la función de compartir para enviar correo no deseado (spam) o acosar; o (d) interferir con la App o el uso de la misma por parte de otros. Podremos restringir el acceso a funciones específicas ante incumplimientos graves.'
      },
      {
        title: '10. Contenido de terceros',
        body: 'Read Later muestra vistas previas y abre enlaces de sitios web y servicios de terceros. Nosotros no alojamos, controlamos ni respaldamos ese contenido, ni nos hacemos responsables de su veracidad o legalidad. El uso de cualquier sitio enlazado se rige por las condiciones de dicho sitio.'
      },
      {
        title: '11. Nuestra propiedad intelectual',
        body: 'El nombre de Read Later, su diseño, iconos, código fuente y marca son de nuestra propiedad o se utilizan bajo licencia. La licencia detallada en la sección 2 no te transfiere ningún derecho sobre ellos. Puedes mencionar la App o enlazar a getreadlater.com en reseñas o publicaciones, sin implicar nuestro patrocinio sin autorización.'
      },
      {
      ...
      },
      {
        ...
        body: 'Read Later se proporciona "tal cual" y "según disponibilidad". En la medida que la ley lo permita, excluimos cualquier otra garantía de funcionamiento ininterrumpido o libre de errores de la App, o de que los metadatos de terceros sean precisos. Nada en estas condiciones afecta a tus derechos legales como consumidor.'
      },
      {
      ...
      {
        title: '18. Contacto',
        body: '¿Tienes dudas sobre estas condiciones? Escribe a support@getreadlater.com. Disponemos de dirección postal en el Reino Unido bajo petición para correspondencia formal.'
      }
    ]
  }
};
